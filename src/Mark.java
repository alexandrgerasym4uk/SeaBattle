...
public class Mark extends Rectangle {
    ...
    /**
     * Скидає прив'язку до корабля, робиться невидимою.
     */
    public void reset() {
        markedShip = null;
        showMark = false;
    ...
    /**
     * Зберігає інформацію про корабель.
     *
    ...
    /**
     * Малює точку.
     * Використовує колір залежно від того, чи ця точка знаходиться над кораблем.
     *

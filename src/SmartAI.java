...
public class SmartAI extends BattleshipAI {
     ...
     * AI вибере атаку поруч із відомими місцями ураження корабля, якщо корабель був ранений, інакше
    ...
    /**
     * Отримує список ходів, що прилягають до hitShips, і вибирає один випадковим чином.
     *
    ...
    /**
     * Отримує список ходів, що прилягають до hitShips, і вибирає один на основі
    ...
    /**
     * Отримує суміжні комірки навколо кожного shipHit і створює унікальний список
